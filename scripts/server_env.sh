...
export CG_FOLDER="$CG_ALI_FOLDER"  # backward-compatible name used by old helpers
...
export REPLICA_CONFIG_PATH="$CG_ALI_FOLDER/conceptgraph/dataset/dataconfigs/replica/replica.yaml"
